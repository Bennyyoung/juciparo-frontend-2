...
function Category() {
  return (
    <div className="grid h-screen place-items-center md:grid-cols-4 sm:grid-cols-2 grid-cols-1 pl-80 pr-80 sm:pl-10 sm:pr-10 ml-20 mr-20">
      <div className="h-80 bg-white-100 shadow-lg w-40">
        <div className="bg-red-500 w-20 rounded">
          <button className="text-white text-sm p-2">New</button>
        </div>
        <div className="p-1 -mt-1">
          <img src={laptop} alt="laptop" />
        </div>
        <div>
          <p className="text-sm text-left mx-2 mt-2">Adidas sport <br />sneakers</p>
        </div>
        <div className="flex flex mt-2">
          <p className="text-sm text-left mx-2">&#8358;<spna className="text-red-500">500</spna></p>
          <p className="text-sm text-left mx-2"><span className="line-through">&#8358;600</span></p>
        </div>
      ...
      <div className="h-80 bg-white-100 shadow-lg w-40">
        ...
        <div>
          <p className="text-sm text-left mx-2 mt-7">Adidas sport <br />sneakers</p>
        </div>
        <div className="flex flex mt-2">
          <p className="text-sm text-left mx-2">&#8358;<spna className="text-red-500">500</spna></p>
          <p className="text-sm text-left mx-2"><span className="line-through">&#8358;600</span></p>
      ...
      <div className="h-80 bg-white-100 shadow-lg w-40">
        ...
        <div>
          <p className="text-sm text-left mx-2 -mt-0.5">Adidas sport <br />sneakers</p>
        </div>
        <div className="flex flex mt-2">
          <p className="text-sm text-left mx-2">&#8358;<spna className="text-red-500">500</spna></p>
          <p className="text-sm text-left mx-2"><span className="line-through">&#8358;600</span></p>
      ...
      <div className="h-80 bg-white-100 shadow-lg w-40">
        ...
        <div>
          <p className="text-sm text-left mx-2 -mt-11">Adidas sport <br />sneakers</p>
        </div>
        <div className="flex flex mt-2">
          <p className="text-sm text-left mx-2">&#8358;<spna className="text-red-500">500</spna></p>
          <p className="text-sm text-left mx-2"><span className="line-through">&#8358;600</span></p>
      ...
      <div className="h-80 bg-white-100 shadow-lg w-40">
        ...
        <div>
          <p className="text-sm text-left mx-2 -mt-1">Adidas sport <br />sneakers</p>
        </div>
        <div className="flex flex mt-2">
          <p className="text-sm text-left mx-2">&#8358;<spna className="text-red-500">500</spna></p>
          <p className="text-sm text-left mx-2"><span className="line-through">&#8358;600</span></p>
